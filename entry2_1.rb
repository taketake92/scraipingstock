...
mCodes.each{|mCode|
  ...
  #スプレッドシートへの書き込み
  sheets[UpdateCount,1] = mCode.to_s #銘柄コード
  sheets[UpdateCount,2] = "2019-10-18" #日付
  sheets[UpdateCount,3] = a9 #前日比
  sheets[UpdateCount,4] = a10 #前日比(㌫)
  sheets[UpdateCount,5] = a3 #始値
  sheets[UpdateCount,7] = a4 #高値
  sheets[UpdateCount,8] = a5 #高値(時刻)
  sheets[UpdateCount,9] = a6 #安値
  sheets[UpdateCount,10] = a7 #安値(時刻)
